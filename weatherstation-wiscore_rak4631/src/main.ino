...
uint8_t nodeDeviceEUI[8] = {0x60, 0x81, 0xF9, 0xFE, 0xA8, 0x8A, 0x3A, 0x7F}; // Replace the "88's" with your device's info from Helium Console
uint8_t nodeAppEUI[8] = {0x60, 0x81, 0xF9, 0x92, 0xC7, 0xE8, 0x65, 0x3F};
uint8_t nodeAppKey[16] = {0xA6, 0x91, 0xCC, 0xFB, 0x19, 0x88, 0x62, 0x2C, 0xB8, 0x53, 0x6B, 0xD5, 0xF2, 0xD7, 0x6D, 0x3A};

// ABP keys
uint32_t nodeDevAddr = 0x88888888; // This ABP keys are not required for OTAA, delete them or use the device's info from Helium Console
uint8_t nodeNwsKey[16] = {0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88}; // These Keys are not required for OTAA
uint8_t nodeAppsKey[16] = {0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88}; // You can delete them or fill them in with the Keys from your Helium Console
