...
uint8_t nodeDeviceEUI[8] = 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88}; // Replace the "88's" with your device's info from Helium Console
uint8_t nodeAppEUI[8] = 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x8};
